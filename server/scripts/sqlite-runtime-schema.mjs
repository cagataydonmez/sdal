...
export function ensureUyelerCompatibilityColumns(db) {
  const alterStatements = [
    ...
    'ALTER TABLE uyeler ADD COLUMN teacher_subject TEXT',
    'ALTER TABLE uyeler ADD COLUMN teacher_subject_other TEXT',
    'ALTER TABLE uyeler ADD COLUMN teacher_started_year INTEGER',
    'ALTER TABLE uyeler ADD COLUMN teacher_ended_year INTEGER',
    'ALTER TABLE uyeler ADD COLUMN teacher_currently_working INTEGER DEFAULT 0',
