  ...
  app.get('/api/session', (req, res) => {
    ...
    const user = current
      ? {
        ...
        sehir: current.sehir,
        meslek: current.meslek,
        websitesi: current.websitesi,
        universite: current.universite,
        dogumgun: current.dogumgun,
        dogumay: current.dogumay,
        dogumyil: current.dogumyil,
        imza: current.imza,
        sirket: current.sirket,
        unvan: current.unvan,
        uzmanlik: current.uzmanlik,
        linkedin_url: current.linkedin_url,
        universite_bolum: current.universite_bolum,
        mentor_konulari: current.mentor_konulari,
