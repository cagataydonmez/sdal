...
const trFallbackMessages = {
  ...
  nav_whatsapp: 'WhatsApp Sohbet',
  whatsapp_title: 'WhatsApp Mesajlaşma',
  whatsapp_subtitle: 'Anlık mesajlar burada canlı akar.',
  whatsapp_load_failed: 'Mesajlar yüklenemedi.',
  whatsapp_open_module: 'WhatsApp Sohbeti Aç',
  anonymous: 'anon',
...
const messages = {
  ...
  en: {
    ...
    nav_whatsapp: 'WhatsApp Chat',
    whatsapp_open_module: 'Open WhatsApp Chat',
  ...
  de: {
    ...
    nav_whatsapp: 'WhatsApp-Chat',
    whatsapp_open_module: 'WhatsApp-Chat öffnen',
  ...
  fr: {
    ...
    nav_notifications: 'Notifications',
    nav_whatsapp: 'Chat WhatsApp',
    whatsapp_open_module: 'Ouvrir le chat WhatsApp',
