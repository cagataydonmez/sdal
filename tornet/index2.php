...
<?
if(empty($isim)) {
die("<hr color=ededed size=1><center>lütfen isminizi yazınız...&nbsp;&nbsp;&nbsp;&nbsp;<a href=javascript:history.back(1); title='geri dön'>geri dön</a><hr color=ededed size=1></center>");
}
if(empty($metin)) {
die("<hr color=ededed size=1><center>lütfen metninizi yazınız...&nbsp;&nbsp;&nbsp;&nbsp;<a href=javascript:history.back(1); title='geri dön'>geri dön</a><hr color=ededed size=1></center>");
}


$metin = ereg_replace("<","&lt;",$metin);
$metin = ereg_replace(">","&gt;",$metin);
$metin = ereg_replace(chr(9),"   ",$metin);
$metin = ereg_replace("   ","&nbsp;&nbsp;",$metin);

$isim = ereg_replace("<","&lt;",$isim);
$isim = ereg_replace(">","&gt;",$isim);
$isim = ereg_replace(chr(9),"   ",$isim);
$isim = ereg_replace("   ","&nbsp;&nbsp;",$isim);

$metin = ereg_replace(chr(13),"<br>",$metin);
...
$ks = mysql_query("insert into nedir (isim,metin,tarih,ip) values ('$isim','$metin','$tarih','$ip') ",$bag);

?>
Teşekürler kaydınız başarıyla tamamlandı!!<br><br>
