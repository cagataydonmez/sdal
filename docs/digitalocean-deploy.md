...
Not: deploy script, `SDAL_DB_DRIVER=postgres` oldugunda ilk deployda SQLite -> PostgreSQL migrationi bir kez calistirir.
...
`main` branch'e push oldugunda `.github/workflows/deploy.yml` otomatik deploy calistirir.

## 10) Yedekleme Onerisi
