...
final class LocalizationManager: ObservableObject {
    ...
    func t(_ key: String) -> String {
        let tr: [String: String] = [
            ...
            "site_closed_title": "Site Su Anda Kapali",
            "site_closed_message": "Girisler gecici olarak durduruldu. Lutfen daha sonra tekrar dene.",
            "complete_profile_title": "Profilini Tamamla",
            "complete_profile_message": "Devam etmeden once temel profil bilgilerini doldurman gerekiyor.",
            "mode": "Mod",
        ...
        let en: [String: String] = [
            ...
            "site_closed_title": "Site Is Currently Closed",
            "site_closed_message": "Sign-ins are temporarily disabled. Please try again later.",
            "complete_profile_title": "Complete Your Profile",
            "complete_profile_message": "You need to finish the required profile fields before continuing.",
            "mode": "Mode",
            "reload": "Reload",
