export const MODULE_CONTROL_ITEMS = [
  { key: 'feed', path: '/new', labelKey: 'nav_feed', defaultLabel: 'Akış', menu: true, category: 'feed', icon: 'home' },
  ...
  { key: 'groups', path: '/new/groups', labelKey: 'nav_groups', defaultLabel: 'Gruplar', menu: true, category: 'feed', icon: 'users' },
  { key: 'albums', path: '/new/albums', labelKey: 'nav_photos', defaultLabel: 'Albüm/Fotolar', menu: true, category: 'feed', icon: 'image' },
  { key: 'events', path: '/new/events', labelKey: 'nav_events', defaultLabel: 'Etkinlikler', menu: true, category: 'feed', icon: 'calendar' },
  { key: 'announcements', path: '/new/announcements', labelKey: 'nav_announcements', defaultLabel: 'Duyurular', menu: true, category: 'feed', icon: 'badge-alert' },
  { key: 'networking', path: '/new/network/hub', labelKey: 'nav_network_hub', defaultLabel: 'Ağ Merkezi', menu: true, category: 'network', icon: 'waypoints' },
  ...
  { key: 'messages', path: '/new/messages', labelKey: 'nav_messages', defaultLabel: 'SDAL Gelen Kutusu', menu: true, category: 'global', icon: 'mailbox' },
  { key: 'profile', path: '/new/profile', labelKey: 'nav_profile', defaultLabel: 'Profil', menu: true, category: 'global', icon: 'user' },
  { key: 'help', path: '/new/help', labelKey: 'nav_help', defaultLabel: 'Yardım', menu: true, category: 'global', icon: 'circle-help' },
  { key: 'requests', path: '/new/requests', labelKey: 'requests_title', defaultLabel: 'Yönetim Talepleri', menu: true, category: 'global', icon: 'clipboard-check' },
  { key: 'games', path: '/new/games', labelKey: 'nav_games', defaultLabel: 'Oyunlar', menu: true, category: 'global', icon: 'sparkles' }
];
