...
const messages = {
  tr: {
    ...
    main_feed_public_note: 'Ana Akış herkese açıktır. Topluluk Akışı sadece kendi topluluğunuzun gönderilerini gösterir.',
    nav_explore: 'Keşfet',
  ...
  en: {
    ...
    main_feed_public_note: 'Main Feed is visible to everyone. Community Feed only shows posts from your own community.',
    nav_explore: 'Explore',
  ...
  de: {
    ...
    community_feed: 'Community-Feed',
    main_feed_public_note: 'Der Haupt-Feed ist für alle sichtbar. Der Community-Feed zeigt nur Beiträge aus deiner eigenen Community.',
  ...
  fr: {
    ...
    main_feed_public_note: 'Le flux principal est visible par tout le monde. Le flux de communauté affiche uniquement les publications de votre communauté.',
