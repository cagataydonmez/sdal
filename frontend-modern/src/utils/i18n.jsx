...
const messages = {
  tr: {
    ...
    nav_groups: 'Gruplar',
    nav_messages: 'SDAL Gelen Kutusu',
    nav_messenger: 'SDAL Mesajlaşma',
    ...
    nav_feed_category: 'Akış',
    nav_network_category: 'Ağ ve Fırsatlar',
    nav_global_category: 'Genel',
    network_category_title: 'Ağ ve Fırsatlar',
    explore_connections_title: 'Bağlantı Keşfi',
    explore_connections_note: 'Keşfet, topluluk içindeki insanları bulmak ve yeni bağlantılar açmak için kullanılan keşif yüzeyidir.',
    following_connections_note: 'Takip ettiklerin burada görünür. Yakın çevreni izlerken ağ merkezine ve yeni keşif akışlarına buradan dönebilirsin.',
    nav_profile: 'Profil',
    nav_help: 'Yardım',
    nav_admin: 'Yönetim',
    nav_notifications: 'Bildirimler',
    requests_title: 'Yönetim Talepleri',
    profile_preview_members: 'Profilim nasıl görünüyor?',
    messenger_private_note: 'SDAL Messenger özel konuşmalar içindir. Canlı Sohbet ise Akış içindeki ortak topluluk alanı olarak kalır.',
    follow: 'Takip Et',
  ...
  en: {
    ...
    nav_feed: 'Feed',
    main_feed: 'All SDAL',
    community_feed: 'My Community',
    main_feed_public_note: 'See posts from across SDAL. This is the widest view.',
    community_feed_note: 'See posts only from your own community. Best for staying close to your circle.',
    feed_scope_prompt: 'Which feed do you want to see?',
    feed_filter_prompt: 'How should posts be ordered?',
    feed_scope_selected: 'Selected feed',
    feed_filter_selected: 'Selected order',
    nav_explore: 'Explore',
    ...
    nav_feed_category: 'Feed',
    nav_network_category: 'Network & Opportunities',
    nav_global_category: 'Global',
    network_category_title: 'Network & Opportunities',
    explore_connections_title: 'Connection Discovery',
    explore_connections_note: 'Explore is the discovery surface for finding people in the community and opening new relationships.',
    following_connections_note: 'Following shows the people you keep close. From here you can return to discovery or the broader network hub.',
    ...
    requests_title: 'Management Requests',
    profile_preview_members: 'How my profile appears?',
    messenger_private_note: 'SDAL Messenger is for private conversations. Live Chat remains the shared community space inside Feed.',
  ...
  de: {
    ...
    nav_feed: 'Feed',
    main_feed: 'Ganz SDAL',
    community_feed: 'Meine Community',
    main_feed_public_note: 'Du siehst Beiträge aus ganz SDAL. Das ist die breiteste Ansicht.',
    community_feed_note: 'Du siehst nur Beiträge aus deiner eigenen Community. Gut, um nah an deinem Kreis zu bleiben.',
    feed_scope_prompt: 'Welchen Feed möchtest du sehen?',
    feed_filter_prompt: 'Wie sollen die Beiträge sortiert werden?',
    feed_scope_selected: 'Gewählter Feed',
    feed_filter_selected: 'Gewählte Sortierung',
    nav_explore: 'Entdecken',
    nav_following: 'Gefolgte',
    nav_groups: 'Gruppen',
    nav_messages: 'SDAL Postfach',
    nav_messenger: 'SDAL Nachrichten',
    nav_photos: 'Fotos',
    nav_games: 'Spiele',
    ...
    nav_feed_category: 'Feed',
    nav_network_category: 'Netzwerk und Chancen',
    nav_global_category: 'Allgemein',
    network_category_title: 'Netzwerk und Chancen',
    explore_connections_title: 'Verbindungsentdeckung',
    explore_connections_note: 'Entdecken ist die Flache, auf der du Menschen in der Community findest und neue Beziehungen anbahnst.',
    following_connections_note: 'Hier siehst du die Personen, denen du folgst. Von hier gelangst du zuruck zur Entdeckung oder in den Netzwerk-Hub.',
    ...
    requests_title: 'Verwaltungsanfragen',
    profile_preview_members: 'Wie sieht mein Profil aus?',
    messenger_private_note: 'SDAL Messenger ist fur private Gesprache gedacht. Der Live-Chat bleibt der gemeinsame Community-Bereich im Feed.',
  ...
  fr: {
    ...
    nav_feed: 'Fil',
    main_feed: 'Tout SDAL',
    community_feed: 'Ma communaute',
    main_feed_public_note: 'Vous voyez les publications de tout SDAL. C est la vue la plus large.',
    community_feed_note: 'Vous voyez seulement les publications de votre communaute. Ideal pour rester proche de votre cercle.',
    feed_scope_prompt: 'Quel fil voulez-vous voir ?',
    feed_filter_prompt: 'Comment classer les publications ?',
    feed_scope_selected: 'Fil choisi',
    feed_filter_selected: 'Tri choisi',
    nav_explore: 'Explorer',
    nav_following: 'Abonnements',
    nav_groups: 'Groupes',
    nav_messages: 'Boîte SDAL',
    nav_messenger: 'Messagerie SDAL',
    nav_photos: 'Photos',
    nav_games: 'Jeux',
    ...
    nav_feed_category: 'Fil',
    nav_network_category: 'Réseau et opportunités',
    nav_global_category: 'Global',
    network_category_title: 'Reseau et opportunites',
    explore_connections_title: 'Decouverte des liens',
    explore_connections_note: 'Explorer est la surface de decouverte pour trouver des personnes dans la communaute et ouvrir de nouvelles relations.',
    following_connections_note: 'Cette vue montre les personnes que vous suivez. Vous pouvez repartir vers la decouverte ou revenir au hub reseau.',
    ...
    nav_notifications: 'Notifications',
    requests_title: 'Demandes d’administration',
    profile_preview_members: 'Comment mon profil apparaît ?',
    messenger_private_note: 'SDAL Messenger sert aux conversations privees. Le chat en direct reste l espace communautaire partage dans le fil.',
